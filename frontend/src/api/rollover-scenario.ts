...
export const rolloverScenarioApi = {
  ...
  transition: (id: number, toState: ScenarioState, comment = '', riskAcceptance = '') => apiRequest<RolloverScenario>(`/rollover-scenarios/${id}/transition`, { method: 'POST', body: JSON.stringify({ to_state: toState, comment, risk_acceptance: riskAcceptance }) }),
